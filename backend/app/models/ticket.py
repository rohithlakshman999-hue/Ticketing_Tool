...
class Ticket(Base):
    ...
    assigned_technician = relationship("User", foreign_keys=[assigned_technician_id], backref="tickets_assigned")
    ...
    activity = relationship("TicketActivity", back_populates="ticket", cascade="all, delete-orphan")
