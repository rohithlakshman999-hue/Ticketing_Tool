          ...
          <div className="flex items-center gap-2 sm:gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex flex-col text-right">
                <span className="text-sm text-slate-100 font-semibold truncate max-w-[180px]">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium glass-button-secondary rounded-lg border border-red-500/30 hover:bg-red-500/10 text-red-400 transition-all"
              >
                <LogOut size={16} />
